...
$nama = ['Cavin', 'Asep', 'Abdul', 'Martin', 'Denny'];
...
$foreach_array_nama = ['Cavin', 'Hartono', 'Putra'];
...
variableFunction('Cavin', 'sampleFunction');
...
function_biasa('Cavin', function (string $nama) {
...
var_dump(explode(" ", "Cavin Hartono Putra")); // Memecah string menjadi array
echo strtolower("Cavin Hartono Putra") . PHP_EOL; // String menjadi huruf kecil
echo strtoupper("Cavin Hartono Putra") . PHP_EOL; // String menjadi huruf besar
echo trim("   Cavin Hartono Putra      ") . PHP_EOL; // Menghapus whitespace di depan dan belakang string
echo substr("Cavin Hartono Putra", 0, 5) . PHP_EOL; // Mengambil sebagian string

echo "Variable Global Scope dan Local Scope" . PHP_EOL;

$global_scope = "Cavin"; // Global variable

function createName()
{
  $local_scope = "Cavin"; // Local variable
}

echo "Reference" . PHP_EOL;

$var_referenceBaru = "Cavin";
$var_referenceLain = &$var_referenceBaru; // maka valuenya jadi 'Cavin'
$var_referenceLain = "Hartono"; // dari 'Cavin' jadi 'Hartono'
